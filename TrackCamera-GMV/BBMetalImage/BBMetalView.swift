...
public class BBMetalView: MTKView {
    ...
    private var textureRotation: TextureRotation = .rotate90Degrees // for internal drawing
    private var tempTextureRotation: TextureRotation = .rotate90Degrees // for external setter
